...
class ChaptersControllerTest < ActionController::TestCase
  ...
  test "should create chapter" do
    assert_difference('Chapter.count') do
      post :create, chapter: { chapterNumber: @chapter.chapterNumber, name: @chapter.name, term: @chapter.term }
    end
  ...
  test "should update chapter" do
    patch :update, id: @chapter, chapter: { chapterNumber: @chapter.chapterNumber, name: @chapter.name, term: @chapter.term }
    assert_redirected_to chapter_path(assigns(:chapter))
  end
